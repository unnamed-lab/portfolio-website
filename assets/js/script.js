...
window.addEventListener("scroll", function () {
  ...
  if (sPosition >= wH * 0.5) navBar.classList.add("sidebar");
    ...
    navBar.classList.contains("sidebar") === true
      ...
      : null;
  //  Removes the sidebar class if it's present
});
...
const homeIcon = `<svg
            ...
            >
              ...
              ></path></svg
          >`;
const aboutIcon = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
...
const skillIcon = `<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
              <path
...
const contactIcon = `<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              <path

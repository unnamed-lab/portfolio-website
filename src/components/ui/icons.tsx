...
export const FbIcon = ({ className }: { readonly className?: string }) => (
  ...
  >
    <g id="Layer_2">
      ...
      ></path>
      <path
        d="M42.665 38.663c-.77 0-1.394.626-1.394 1.399v8.819H30.929c-.77 0-1.394.626-1.394 1.399v13.408c0 .773.624 1.399 1.394 1.399H41.27v29.347C-11.554 82.852-4.204 6.699 49.886 5.298c21.636 0 40.176 15.473 44.084 36.791.14.76.864 1.263 1.624 1.122a1.4 1.4 0 0 0 1.119-1.629C92.561 18.937 72.867 2.5 49.886 2.5c-58.451 1.627-65.011 84.401-7.437 94.981.815.145 1.63-.545 1.609-1.382V63.688c0-.773-.624-1.399-1.394-1.399H32.323v-10.61h10.341c.77 0 1.394-.626 1.394-1.399V40.062a1.395 1.395 0 0 0-1.393-1.399z"
        fill="#ffffff"
        className="fill-000000"
      ></path>
    </g>
...
export const TwitterBoxIcon = ({
  ...
  >
    <g data-name="Layer 6">
      ...
      ></circle>
      <path
        d="M25.49 32.72a12.24 12.24 0 0 1-3.36-1.85 5.4 5.4 0 0 1-1.82-3.77c0-.58-.2-3.5.78-3.43.16 0 .3.15.4.27a11 11 0 0 0 .81.87h0a12 12 0 0 0 8.89 3.36A4.94 4.94 0 0 1 38.42 23a6.15 6.15 0 0 0 1.58.79 3.9 3.9 0 0 0 1.23 0l3-.34a18.05 18.05 0 0 0-2.56 3.93 18.35 18.35 0 0 0-.93 4.15 12.2 12.2 0 0 1-5.16 7.79s0 0 0 0a9.7 9.7 0 0 1-1.18.68h0a11.07 11.07 0 0 1-1.72.78h0l-.55.19-.61.17a18.33 18.33 0 0 1-8.61-.14l-1.17-.27-1.37-.38a10.48 10.48 0 0 0 4.76-1.46c.29-.17.59-.41.55-.73a.83.83 0 0 0-.38-.56 13.92 13.92 0 0 1-2.67-3.16"
        fill="none"
        stroke="#ffffff"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const LinkedInBoxIcon = ({
  ...
  >
    <g data-name="Layer 6">
      ...
      ></circle>
      <path
        d="M28.92 28.08h5v1.64h.1c.64-1 1.7-2 4.31-2 3.23 0 5.64 2.13 5.64 6.77v9.35h-4.9v-8.73c0-2-.71-3.42-2.48-3.42a2.62 2.62 0 0 0-2.48 1.84 3.5 3.5 0 0 0-.11 1.22v9.1h-4.9V32M25.2 32.08v11.9h-4.89v-15.9h4.89M25.52 22.75A2.77 2.77 0 1 1 22.75 20"
        fill="none"
        stroke="#ffffff"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const LangIcon = ({ className }: { readonly className?: string }) => (
  ...
  >
    <path
      d="M17 20H2.5A2.503 2.503 0 0 1 0 17.5v-15C0 1.122 1.122 0 2.5 0h8a.5.5 0 0 1 .473.338l6.5 19A.502.502 0 0 1 17 20zM2.5 1C1.673 1 1 1.673 1 2.5v15c0 .827.673 1.5 1.5 1.5h13.8L10.143 1H2.5z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M21.5 24h-8a.5.5 0 0 1-.468-.324l-1.5-4a.5.5 0 0 1 .936-.352L13.847 23H21.5c.827 0 1.5-.673 1.5-1.5v-15c0-.827-.673-1.5-1.5-1.5H12a.5.5 0 0 1 0-1h9.5C22.878 4 24 5.122 24 6.5v15c0 1.378-1.122 2.5-2.5 2.5z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M13.5 24a.5.5 0 0 1-.376-.83l3.5-4a.5.5 0 1 1 .753.659l-3.5 4A.502.502 0 0 1 13.5 24zM9.5 14a.499.499 0 0 1-.471-.332L7 7.987l-2.029 5.681a.5.5 0 0 1-.942-.336l2.5-7c.142-.398.8-.398.941 0l2.5 7A.5.5 0 0 1 9.5 14z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M8 11H6a.5.5 0 0 1 0-1h2a.5.5 0 0 1 0 1zM21.5 11h-7a.5.5 0 0 1 0-1h7a.5.5 0 0 1 0 1z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M17.5 11a.5.5 0 0 1-.5-.5v-1a.5.5 0 0 1 1 0v1a.5.5 0 0 1-.5.5zM16 17a.498.498 0 0 1-.29-.907c2.189-1.555 3.79-4.727 3.79-5.592a.5.5 0 0 1 1 0c0 1.318-1.927 4.785-4.21 6.408A.507.507 0 0 1 16 17z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M20 18a.494.494 0 0 1-.337-.131c-.363-.332-3.558-3.283-4.126-4.681a.5.5 0 0 1 .926-.376c.409 1.007 2.936 3.459 3.875 4.319A.5.5 0 0 1 20 18z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
  </svg>
...
export const GlobeIcon = ({ className }: { readonly className?: string }) => (
  ...
  >
    ...
    ></ellipse>
    <path
      d="M21.6 6.3H2.4M21.6 17.7H2.4M12 23.3V.8"
      fill="none"
      stroke="#ffffff"
      strokeWidth="1.5"
      strokeLinecap="round"
...
export const SexIcon = ({ className }: { readonly className?: string }) => (
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth="16"
      d="M120 168v64M88 204h64M168 24h40v40M164.4 67.6 208 24"
      className="stroke-000000"
    ></path>
  </svg>
);
export const HobbyIcon = ({ className }: { readonly className?: string }) => (
  ...
  >
    <path
      d="M22 4.9a6.64 6.64 0 0 0-9.4 0c-.2.2-.5.5-.7.8-.2-.3-.4-.5-.7-.8-2.5-2.5-6.6-2.5-9.2 0a6.64 6.64 0 0 0 0 9.4l10 10 10-10c2.6-2.6 2.6-6.8 0-9.4zM20.7 13 12 21.7S3.8 13.4 3.3 13c-1.8-1.8-1.8-4.8 0-6.7 1.8-1.8 4.8-1.8 6.7 0l2 2 2-2c1.8-1.8 4.8-1.8 6.7 0 1.9 1.8 1.9 4.8 0 6.7z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
    <path
      d="M17 7v1c1.1 0 2 .9 2 2 0 .6-.2 1.1-.6 1.4l.7.7c.5-.5.9-1.3.9-2.1 0-1.7-1.3-3-3-3z"
      fill="#ffffff"
      className="fill-000000"
    ></path>
  </svg>
...
export const Icons = {
  ...
  contact: <ContactIcon />,
  facebook: <FbIcon />,
  facebookBox: <FbBoxIcon />,
  twitter: <TwitterIcon />,
  twitterBox: <TwitterBoxIcon />,
  linkedin: <LinkedInIcon />,
  linkedinBox: <LinkedInBoxIcon />,
  github: <GitHubIcon />,
  githubBox: <GitHubBoxIcon />,
  language: <LangIcon />,
  globe: <GlobeIcon />,
  gender: <SexIcon />,
  hobby: <HobbyIcon />,
